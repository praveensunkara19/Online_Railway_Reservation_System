      ...
      <div class="main-content container-fluid">
        <div class="splash-container">
              ...
              <form method="POST">
                <div class="login-form ">
                  ...
                  <div class="form-group row login-submit">
                    ...
                    <div class="col-6"><input type="submit" name="pass_login" class="btn btn-success btn-xl"
                        value="Log In"></div>
                  </div>
          ...
          <div class="splash-footer">&copy; 2023 -
            <?php echo date('Y'); ?> Online Railway Reservation System | Developed and Updated By praveen & Team
          </div>
        </div>
      </div>
    </div>
