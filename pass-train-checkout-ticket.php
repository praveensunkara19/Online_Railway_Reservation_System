            ...
            <div class="card card-table">
              ...
              while ($row = $res->fetch_object()) {
                ...
                <div class="card-header">
                  ...
                  <?php echo $row->pass_lname; ?> This Is Your Booked Train Proceed to checkout your ticket!
                <?php } ?>
              </div>
                  ...
                  <tbody>
                    ...
                    while ($row = $res->fetch_object()) {
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><a
                            href="pass-checkout-ticket.php?pass_id = <?php echo $row->pass_id; ?>"><button
                              class="btn btn-success btn-sm">Checkout</button></a></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
