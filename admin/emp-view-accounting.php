          ...
          <div class="col-12 col-lg-6 col-xl-6">
            <div class="widget widget-tile">
              ...
              <div class="data-info">
                ...
                <div class="value">Rs<span class="number" data-toggle="counter"
                    data-end="<?php echo $count_fare; ?>">0</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-lg-6 col-xl-6">
            <div class="widget widget-tile">
              ...
              <div class="data-info">
                ...
                <div class="value"><span class="indicator indicator-positive mdi mdi-chevron-right"></span><span
                    class="number" data-toggle="counter" data-end="<?php echo $resevations; ?>">0</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="card card-table">
              <div class="card-header">Tickets Payment Status
                ...
                <div class="tools dropdown"><span class=""></span><a class="dropdown-toggle" href="#" role="button"
                    data-toggle="dropdown"><span class=""></span></a>
