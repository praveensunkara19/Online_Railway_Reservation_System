          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Employee Profile<span class="card-subtitle">Fill All
                    Details</span></div>
                <div class="card-body">
                  <form method="POST">
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="emp_fname" value="<?php echo $row->emp_fname; ?>"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="emp_lname" value="<?php echo $row->emp_lname; ?>"
                          id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">National ID
                        Number</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="emp_nat_idno" value="<?php echo $row->emp_nat_idno; ?>"
                          id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="emp_phone" value="<?php echo $row->emp_phone; ?>"
                          id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="emp_addr" value="<?php echo $row->emp_addr; ?>"
                          id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="emp_dept" value="<?php echo $row->emp_dept; ?>"
                          id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="emp_email" value="<?php echo $row->emp_email; ?>"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="emp_uname" value="<?php echo $row->emp_uname; ?>"
                          id="inputText3" type="text">
                      </div>
                    </div>
