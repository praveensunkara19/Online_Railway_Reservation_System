        ...
        <div class="splash-container">
          <div class="card card-border-color card-border-color-danger">
            <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo"
                width="{conf.logoWidth}" height="27"><span class="splash-description">Admin Login Panel</span></div>
            <div class="card-body">
              ...
              <form method="POST">
                <div class="login-form ">
                  ...
                  <div class="form-group row login-submit">
                    <div class="col-12"><input type="submit" name="emp_login" class="btn btn-danger btn-xl btn-block"
                        value="Log In"></div>
                  </div>
          ...
          <div class="splash-footer">&copy; 2023 -
            <?php echo date('Y'); ?> Online Railway Reservation System | Developed and Updated By Praveen Sunkara
          </div>
        </div>
      </div>
    </div>
