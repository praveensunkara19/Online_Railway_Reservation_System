                  ...
                  <tbody>
                    ...
                    while ($row = $res->fetch_object()) {
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center">
                          <?php echo $row->fare_payment_code; ?>
                        </td>
                        <td class="center"><a class="badge badge-success"
                            href="emp-confirm-tickets.php?ticket_id=<?php echo $row->ticket_id; ?>">Manage</a>
                          <hr> <a class="badge badge-danger"
                            href="emp-manage-tickets.php?del=<?php echo $row->ticket_id; ?>">Delete</a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
