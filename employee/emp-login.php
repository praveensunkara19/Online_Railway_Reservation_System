        ...
        <div class="splash-container">
          <div class="card card-border-color card-border-color-success">
            <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo"
                width="{conf.logoWidth}" height="27"><span class="splash-description">Please enter your user
              ...
              <form method="POST">
                <div class="login-form ">
                  ...
                  <div class="form-group row login-tools">
                    ...
                    <div class="col-6 login-forgot-password"><a target="_blank" href="../pass-pwd-forgot.php">Forgot
                        Password?</a></div>
                  </div>

                  <div class="form-group row login-submit">
                    <div class="col-6"><input type="submit" name="emp_login" class="btn btn-success btn-xl"
                        value="Log In"></div>
                  </div>
          ...
          <div class="splash-footer">&copy; 2023 -
            <?php echo date('Y'); ?> Online Railway Reservation System | Developed and Updaed By Praveen Sunkara & Team
          </div>
        </div>
      </div>
    </div>
