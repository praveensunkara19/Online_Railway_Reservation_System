        ...
        <div class="splash-container">
          <div class="card card-border-color card-border-color-success">
            <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo"
                width="{conf.logoWidth}" height="27"><span class="splash-description">Passenger Registration Form</span>
            </div>
            <div class="card-body">
              ...
              <form method="POST">
                <div class="login-form">
                  ...
                  <div class="form-group row login-submit">
                    ...
                    <div class="col-6"><input type="submit" name="pass_register" class="btn btn-outline-danger btn-xl"
                        value="Register"></div>
                  </div>
          ...
          <div class="splash-footer">&copy; 2023 -
            <?php echo date('Y'); ?> Online Railway Reservation System | Developed and Updated By Praveen Sunkara & Team
          </div>
